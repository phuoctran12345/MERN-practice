// ============================================
// FILE: business-insights.controller.ts
// MỤC ĐÍCH: Controller xử lý business logic cho Business Insights
...
// MỤC ĐÍCH: Lấy dữ liệu dashboard business insights
// ENDPOINT: GET /api/business-insights/dashboard
...
// MỤC ĐÍCH: Lấy dữ liệu forecast bookings và revenue
// ENDPOINT: GET /api/business-insights/forecast
// MIDDLEWARE: verifyToken (đã được gọi ở routes)
// ============================================
...
// MỤC ĐÍCH: Lấy performance metrics
// ENDPOINT: GET /api/business-insights/performance
// MIDDLEWARE: verifyToken (đã được gọi ở routes)
// ============================================
